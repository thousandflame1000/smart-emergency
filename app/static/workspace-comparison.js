...
const COMPARISON_FIELDS={label:'名稱',kind:'類型',lat:'緯度',lng:'經度',quantity:'數量',available:'納入分析',source:'來源／起點',target:'終點',status:'關係狀態',directed:'方向性',provenance:'資料來源',properties:'原始屬性',logistics:'品項庫存與需求'};
